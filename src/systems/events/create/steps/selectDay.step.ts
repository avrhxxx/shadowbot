...
import { formatButtonDate, getEventDateUTC } from "@/shared/utils/timeUtils";

// MAX dni do wyświetlenia
const DAYS_TO_SHOW = 8;

/**
 * Rejestracja kroku selectDay
 * Pokazuje przyciski z dzisiejszą datą + 7 kolejnych dni
 */
